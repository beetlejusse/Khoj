  ...
  const cards = [
    {
      ...
      description:
        "Explore destinations, build your map,\nbring your friends together.",
      image: "/modern-dashboard-interface-with-data-visualization.jpg",
    },
    {
      title: "From reels to real life",
      description:
        "Transform saved Instagram reels into mapped routes\nwith our seamless integration.",
      image: "/analytics-dashboard.png",
    },
    {
      title: "Plan collaboratively",
      description:
        "Work together in real-time with your friends\nand share your itinerary instantly.",
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4">
          ...
          <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
            Streamline your travel adventures
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            Manage itineraries, analyze budgets, and collaborate with your
            travel buddies
            <br />
            all in one powerful planner.
          </div>
        </div>
      </div>
