...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "In just a few minutes, we transformed our saved reels into a complete itinerary. The process was seamless and incredibly fun!",
      name: "Jamie Marshall",
      company: "Avid Traveler",
      image:
    ...
    {
      quote:
        "Khoj has revolutionized how my friends and I plan trips. The collaboration saves us from endless group chat debates.",
      name: "Sarah Chen",
      company: "Backpacker",
      image:
    ...
    {
      quote:
        "The automated route planning is a game-changer. What used to take days of Google Maps hopping now happens instantly.",
